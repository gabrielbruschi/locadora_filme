...
namespace ProjetoLocadora {
	...
	/// Summary for casa
	/// </summary>
	public ref class casa : public System::Windows::Forms::Form
	{
	public:
		casa(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"FILME";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &casa::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &casa::button2_Click);
			// 
			// button3
			// 
